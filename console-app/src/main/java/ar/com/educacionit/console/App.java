...
import ar.com.educacionit.repository.parse.impl.FileDelimiterEnum;
...
public class App {
	public static void main(String[] args) throws Exception {
		...
		if(args.length == 0) {
			System.err.println("Debe especificar el path del  archivo");
			System.exit(0);
		}
		...
		AddresBookFileParser parse = new AddresBookFileParser(args[0],FileDelimiterEnum.PUNTOYCOMA);
